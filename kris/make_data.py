...
pos = radius*np.random.uniform(1, 2, size=(N, 1))
...
velr = 0*np.random.uniform(0, 1, size=(N, 1))
...
d[500,:] = [15000, 0, 0, 0, 0, 0, 0]

np.savetxt("data_Nparticles.txt", d, fmt='%f')
